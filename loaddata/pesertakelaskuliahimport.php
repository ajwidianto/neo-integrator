...
$no = 1;
if ($show == 'yes') {
    $tampil = '<a href="?module=inject&act=pesertakelaskuliahimport&show=no"><button type="button" class="btn btn-danger">
    SEMBUNYIKAN DATA <span class="badge bg-transparent"></span></button></a>';
    $query = "select * from insertpesertakelaskuliah";
    ...
    $tampil = '<a href="?module=inject&act=pesertakelaskuliahimport&show=no"><button type="button" class="btn btn-danger">
    SEMBUNYIKAN DATA <span class="badge bg-transparent"></span></button></a>';
    $query = "select * from insertpesertakelaskuliah where err_no='0'";
    $hasil = mysqli_query($db, $query);
    if (mysqli_num_rows($hasil) > 0) {
        echo "<table class='table table-striped' border='1'><tr>
        <th>Baris</th><th>NIM</th><th>Nama</th><th>Program Studi</th><th>ID Kelas Kuliah</th>
    ...
    SUM(err_no IS NOT NULL AND err_no!='0') AS gagal FROM insertpesertakelaskuliah;";
    ...
    $tampil = '<a href="?module=inject&act=pesertakelaskuliahimport&show=no"><button type="button" class="btn btn-danger">
    SEMBUNYIKAN DATA <span class="badge bg-transparent"></span></button></a>';
    $query = "select * from insertpesertakelaskuliah where err_no!='0' and err_no is not null";
    $hasil = mysqli_query($db, $query);
    if (mysqli_num_rows($hasil) > 0) {
        echo "<table class='table table-striped' border='1'><tr>
        <th>Baris</th><th>NIM</th><th>Nama</th><th>Program Studi</th><th>ID Kelas Kuliah</th>
    ...
    $tampil = '<a href="?module=inject&act=pesertakelaskuliahimport"><button type="button" class="btn btn-primary">
...
echo '<div class="card-body">
    <div class="buttons">
        ...
        <a href="?module=inject&act=pesertakelaskuliahimport&show=berhasil">
        ...
        <a href="?module=inject&act=pesertakelaskuliahimport&show=gagal">
