...
$no = 1;
if ($show == 'yes') {
    $tampil = '<a href="?module=inject&act=updateaktivitasmhsimport&show=no"><button type="button" class="btn btn-danger">
    SEMBUNYIKAN DATA <span class="badge bg-transparent"></span></button></a>';
    $query = "select * from updateaktivitasmahasiswa";
    ...
    $tampil = '<a href="?module=inject&act=updateaktivitasmhsimport&show=no"><button type="button" class="btn btn-danger">
    SEMBUNYIKAN DATA <span class="badge bg-transparent"></span></button></a>';
    $query = "select * from updateaktivitasmahasiswa where err_no='0'";
    $hasil = mysqli_query($db, $query);
    if (mysqli_num_rows($hasil) > 0) {
        echo "<table class='table table-striped' border='1'><tr>
        <th>Baris</th><th>Program MBKM</th><th>Kode Program Studi</th><th>Jenjang</th><th>Nama Program Studi</th><th>ID Semester</th><th>Nomor SK Tugas</th><th>Tanggal SK Tugas</th>
    ...
    SUM(err_no IS NOT NULL AND err_no!='0') AS gagal FROM updateaktivitasmahasiswa;";
    ...
    $tampil = '<a href="?module=inject&act=updateaktivitasmhsimport&show=no"><button type="button" class="btn btn-danger">
    SEMBUNYIKAN DATA <span class="badge bg-transparent"></span></button></a>';
    $query = "select * from updateaktivitasmahasiswa where err_no!='0' and err_no is not null";
    $hasil = mysqli_query($db, $query);
    if (mysqli_num_rows($hasil) > 0) {
        echo "<table class='table table-striped' border='1'><tr>
        <th>Baris</th><th>Program MBKM</th><th>Kode Program Studi</th><th>Jenjang</th><th>Nama Program Studi</th><th>ID Semester</th><th>Nomor SK Tugas</th><th>Tanggal SK Tugas</th>
    ...
    $tampil = '<a href="?module=inject&act=updateaktivitasmhsimport"><button type="button" class="btn btn-primary">
...
echo '<div class="card-body">
    <div class="buttons">
        ...
        <a href="?module=inject&act=updateaktivitasmhsimport&show=berhasil">
        ...
        <a href="?module=inject&act=updateaktivitasmhsimport&show=gagal">
