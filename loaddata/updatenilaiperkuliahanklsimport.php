...
$query = "select * from progress where act='UpdateAktivitasMahasiswa'";
...
$no = 1;
if ($show == 'yes') {
    $tampil = '<a href="?module=inject&act=updatenilaiperkuliahanklsimport&show=no"><button type="button" class="btn btn-danger">
    SEMBUNYIKAN DATA <span class="badge bg-transparent"></span></button></a>';
    $query = "select * from updatenilaiperkuliahankls";
    $hasil = mysqli_query($db, $query);
    if (mysqli_num_rows($hasil) > 0) {
        echo "<table class='table table-striped' border='1'><tr>
        <th>Baris</th><th>NIM</th><th>Nama</th><th>Program Studi</th><th>ID Reg Mhs</th><th>ID Kelas Kuliah</th><th>Nilai Angka</th><th>Nilai Huruf</th><th>Nilai Indeks</th>
        ...
        while ($x = mysqli_fetch_array($hasil)) {
            ...
            echo "</td><td>" . $x['id_registrasi_mahasiswa'];
    ...
    $tampil = '<a href="?module=inject&act=updatenilaiperkuliahanklsimport&show=no"><button type="button" class="btn btn-danger">
    SEMBUNYIKAN DATA <span class="badge bg-transparent"></span></button></a>';
    $query = "select * from updatenilaiperkuliahankls where err_no='0'";
    $hasil = mysqli_query($db, $query);
    if (mysqli_num_rows($hasil) > 0) {
        echo "<table class='table table-striped' border='1'><tr>
        <th>Baris</th><th>NIM</th><th>Nama</th><th>Program Studi</th><th>ID Reg Mhs</th><th>ID Kelas Kuliah</th><th>Nilai Angka</th><th>Nilai Huruf</th><th>Nilai Indeks</th>
    ...
    SUM(err_no IS NOT NULL AND err_no!='0') AS gagal FROM updatenilaiperkuliahankls;";
    ...
    $tampil = '<a href="?module=inject&act=updatenilaiperkuliahanklsimport&show=no"><button type="button" class="btn btn-danger">
    SEMBUNYIKAN DATA <span class="badge bg-transparent"></span></button></a>';
    $query = "select * from updatenilaiperkuliahankls where err_no!='0' and err_no is not null";
    $hasil = mysqli_query($db, $query);
    if (mysqli_num_rows($hasil) > 0) {
        echo "<table class='table table-striped' border='1'><tr>
        <th>Baris</th><th>NIM</th><th>Nama</th><th>Program Studi</th><th>ID Reg Mhs</th><th>ID Kelas Kuliah</th><th>Nilai Angka</th><th>Nilai Huruf</th><th>Nilai Indeks</th>
    ...
    $tampil = '<a href="?module=inject&act=updatenilaiperkuliahanklsimport"><button type="button" class="btn btn-primary">
...
echo '<div class="card-body">
    <div class="buttons">
        ...
        <a href="?module=inject&act=updatenilaiperkuliahanklsimport&show=berhasil">
        ...
        <a href="?module=inject&act=updatenilaiperkuliahanklsimport&show=gagal">
