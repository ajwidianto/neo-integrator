...
$query = "select * from progress where act='UpdateBiodataMahasiswa'";
...
$no = 1;
if ($show == 'yes') {
    $tampil = '<a href="?module=inject&act=updatebiodatamahasiswaimport&show=no"><button type="button" class="btn btn-danger">
    SEMBUNYIKAN DATA <span class="badge bg-transparent"></span></button></a>';
    $query = "select * from updatebiodatamahasiswa";
    $hasil = mysqli_query($db, $query);
    if (mysqli_num_rows($hasil) > 0) {
        echo "<table class='table table-striped' border='1'><tr>
        <th>Baris</th><th>Nama</th><th>ID_Mahasiswa</th><th>Data 1</th><th>Data 2</th><th>Data 3</th><th>Data 4</th><th>Data 5</th><th>Error</th><th>Description</th></tr>";
    ...
    $tampil = '<a href="?module=inject&act=updatebiodatamahasiswaimport&show=no"><button type="button" class="btn btn-danger">
    SEMBUNYIKAN DATA <span class="badge bg-transparent"></span></button></a>';
    $query = "select * from updatebiodatamahasiswa where err_no='0'";
    $hasil = mysqli_query($db, $query);
    if (mysqli_num_rows($hasil) > 0) {
        echo "<table class='table table-striped' border='1'><tr>
        <th>Baris</th><th>Nama</th><th>ID_Mahasiswa</th><th>Data 1</th><th>Data 2</th><th>Data 3</th><th>Data 4</th><th>Data 5</th><th>Error</th><th>Description</th></tr>";
    ...
    SUM(err_no IS NOT NULL AND err_no!='0') AS gagal FROM updatebiodatamahasiswa;";
    ...
    $tampil = '<a href="?module=inject&act=updatebiodatamahasiswaimport&show=no"><button type="button" class="btn btn-danger">
    SEMBUNYIKAN DATA <span class="badge bg-transparent"></span></button></a>';
    $query = "select * from updatebiodatamahasiswa where err_no!='0' and err_no is not null";
    $hasil = mysqli_query($db, $query);
    if (mysqli_num_rows($hasil) > 0) {
        echo "<table class='table table-striped' border='1'><tr>
        <th>Baris</th><th>Nama</th><th>ID_Mahasiswa</th><th>Data 1</th><th>Data 2</th><th>Data 3</th><th>Data 4</th><th>Data 5</th><th>Error</th><th>Description</th></tr>";
    ...
    $tampil = '<a href="?module=inject&act=updatebiodatamahasiswaimport"><button type="button" class="btn btn-primary">
...
echo '<div class="card-body">
    <div class="buttons">
        ...
        <a href="?module=inject&act=updatebiodatamahasiswaimport&show=berhasil">
        ...
        <a href="?module=inject&act=updatebiodatamahasiswaimport&show=gagal">
