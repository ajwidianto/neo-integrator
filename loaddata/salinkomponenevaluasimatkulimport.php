...
$query = "select * from progress where act='SalinKomponenEvaluasiMatkul'";
...
$no = 1;
if ($show == 'yes') {
    $tampil = '<a href="?module=inject&act=salinkomponenevaluasimatkulimport&show=no"><button type="button" class="btn btn-danger">
    SEMBUNYIKAN DATA <span class="badge bg-transparent"></span></button></a>';
    $query = "select * from insertsalinkomponenevaluasimatkul";
    $hasil = mysqli_query($db, $query);
    if (mysqli_num_rows($hasil) > 0) {
        echo "<table class='table table-striped' border='1'><tr>
        <th>Baris</th><th>ID Matkul</th><th>ID Kelas Kuliah</th><th>Error</th><th>Description</th></tr>";
    ...
    $tampil = '<a href="?module=inject&act=salinkomponenevaluasimatkulimport&show=no"><button type="button" class="btn btn-danger">
    SEMBUNYIKAN DATA <span class="badge bg-transparent"></span></button></a>';
    $query = "select * from insertsalinkomponenevaluasimatkul where err_no='0'";
    $hasil = mysqli_query($db, $query);
    if (mysqli_num_rows($hasil) > 0) {
        echo "<table class='table table-striped' border='1'><tr>
        <th>Baris</th><th>ID Matkul</th><th>ID Kelas Kuliah</th><th>Error</th><th>Description</th></tr>";
    ...
    SUM(err_no IS NOT NULL AND err_no!='0') AS gagal FROM insertsalinkomponenevaluasimatkul;";
    ...
    $tampil = '<a href="?module=inject&act=salinkomponenevaluasimatkulimport&show=no"><button type="button" class="btn btn-danger">
    SEMBUNYIKAN DATA <span class="badge bg-transparent"></span></button></a>';
    $query = "select * from insertsalinkomponenevaluasimatkul where err_no!='0' and err_no is not null";
    $hasil = mysqli_query($db, $query);
    if (mysqli_num_rows($hasil) > 0) {
        echo "<table class='table table-striped' border='1'><tr>
        <th>Baris</th><th>ID Matkul</th><th>ID Kelas Kuliah</th><th>Error</th><th>Description</th></tr>";
    ...
    $tampil = '<a href="?module=inject&act=salinkomponenevaluasimatkulimport"><button type="button" class="btn btn-primary">
...
echo '<div class="card-body">
    <div class="buttons">
        ...
        <a href="?module=inject&act=salinkomponenevaluasimatkulimport&show=berhasil">
        ...
        <a href="?module=inject&act=salinkomponenevaluasimatkulimport&show=gagal">
