<?php
          $show = $_POST['show'];
          $namatable = "insertnilaikuliahkelas2";
          $act="nilaiimport";
          ...
          <th>No</th><th>Nim</th><th>nama_mahasiswa</th><th>Kode MK</th>
          <th><pre>Nilai(Index;Angka;Huruf)</th><th>semester</th><th>Kelas Kuliah</th><th>Error</th><th>Description</th></tr>";
          ...
          if(mysqli_num_rows($hasil) > 0 ){
                    ...
                    echo "<tr><td>" . $no++;
                    echo "</td><td><pre>" . $x['nim'];
                    echo "</td><td><pre>" . $x['nama_mahasiswa'];
                    echo "</td><td><pre>" . $x['kode_mata_kuliah'];
                    echo "</td><td><pre>" . $x['nilai_angka'].";".$x['nilai_indeks'].";".$x['nilai_huruf'];
                    echo "</td><td><pre>" . $x['id_periode'];
                    echo "</td><td><pre>" . $x['id_kelas'];
