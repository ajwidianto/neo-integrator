...
$ModuleName = "UPDATE NILAI PERKULIAHAN KELAS";
$table = "updatenilaiperkuliahankls";
                    ...
                    <a href="' . $link2 . '"><button class="btn btn-success ml-1" >LIHAT DATA / LANJUTKAN SYNC</button></a>
                        ...
                        <div class="modal fade text-left" id="cancel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel160" aria-hidden="true">
                            ...
                            if (isset($_POST['input'])) {
                                ...
                                <th>Baris</th><th>NIM</th><th>Nama</th><th>Program Studi</th><th>ID Kelas Kuliah</th><th>Nilai Angka</th><th>Nilai Huruf</th><th>Nilai Indeks</th></tr>";
                                foreach ($line as $baris) {
                                    ...
                                    if (isset($baris[2])) {
                                        ...
                                        $insert = "INSERT INTO updatenilaiperkuliahankls (
                                            id_kelas_kuliah, nim, nama_mahasiswa, nama_program_studi, id_registrasi_mahasiswa, nilai_angka, nilai_huruf, 
                                            nilai_indeks, insertid
                                        ) VALUES (
                                            '$id_kelas_kuliah', '$nim', '$nama_mahasiswa', '$nama_program_studi', '$id_registrasi_mahasiswa', '$nilai_angka', '$nilai_huruf', 
                                            '$nilai_indeks', '$insertid'
                                        )";
