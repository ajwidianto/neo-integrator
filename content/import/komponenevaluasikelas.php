...
$ModuleName = "KOMPONEN EVALUASI KELAS";
$table = "insertkomponenevaluasikelas";
                                                                                ...
                                                                                <div class="card-header">
                                                                                    <table class='table table-striped' id='table1' border='1'>
                                                                                        <tr>
                                                                                            ...
                                                                                            <th>Nama Komponen Evaluasi</th>
                                                                                            <th>Nama Komponen Evaluasi Inggris</th>
                                                                                            <th>Nomor Urut</th>
                                                                                            <th>Bobot Evaluasi (%)</th>
                                                                                        </tr>

                                                                                        <tr>
                                                                                            <td>ID Kelas Kuliah</td>
                                                                                            <td>1 : Evaluasi Akademik; 2 : Aktivitas Partisipatif; <br>3 : Hasil Proyek; 4 : Kognitif/ Pengetahuan</td>
                                                                                            <td>Nama Komponen Evaluasi</td>
                                                                                            <td>Nama Komponen Evaluasi dalam bahasa Inggris</td>
                                                                                            <td>Nomor Urut</td>
                                                                                            <td>Bobot Evaluasi (Tanpa Tanda "%")</td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td>contoh :</td>
                                                                                            <td colspan='7'>
                                                                                                <code>
                                                                                                    <pre>1903017025	3557d958-d07e-4cdb-ba82-d6c9c5ef315e	3</pre>
                                                                                                </code>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                        ...
                        <div class="modal fade text-left" id="cancel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel160" aria-hidden="true">
                            ...
                            if (isset($_POST['input'])) {
                                ...
                                echo "<table class='table table-striped' id='table1' border='1'><tr>
                                    <th>Baris</th><th>ID Kelas Kuliah</th><th>ID Jenis Evaluasi</th><th>Nama Komponen Evaluasi</th><th>Nama Komponen Evaluasi Inggris</th><th>Nomor Urut</th><th>Bobot Evaluasi (%)</th><th>Dosen Pengampu</th><th>Mata Kuliah</th></tr>";
                                foreach ($line as $baris) {
                                    $baris = explode("\t", $baris);
                                    if (isset($baris[2])) {
                                        $no++;
                                        str_replace('"', '', $baris);
                                        $id_kelas_kuliah = $baris[0];
                                        $id_jenis_evaluasi = $baris[1];
                                        $nama = $baris[2];
                                        $nama_inggris = $baris[3];
                                        $nomor_urut= $baris[4];
                                        $bobot_evaluasi = $baris[5];
                                        $datakelaskuliah = caridatakelaskuliah($id_kelas_kuliah);

                                        echo "<tr><td>" . $no;
                                        echo "</td><td>" . $id_kelas_kuliah;
                                        echo "</td><td>" . $id_jenis_evaluasi;
                                        echo "</td><td>" . $nama;
                                        echo "</td><td>" . $nama_inggris;
                                        echo "</td><td>" . $nomor_urut;
                                        echo "</td><td>" . $bobot_evaluasi;
                                        echo "</td><td>" . $datakelaskuliah['nama_dosen'];
                                        echo "</td><td>" . $datakelaskuliah['nama_mata_kuliah'] . "</td></tr>";

                                        // Pastikan $datakelaskuliah sudah terisi sebelum bagian ini
                                        $nama_dosen = $datakelaskuliah['nama_dosen'] ?? 'Tidak Ditemukan';
                                        $nama_mata_kuliah = $datakelaskuliah['nama_mata_kuliah'] ?? 'Tidak Ditemukan';

                                        $insert = "INSERT INTO insertkomponenevaluasikelas (
                                            id_kelas_kuliah, id_jenis_evaluasi, nama, nama_inggris, nomor_urut, bobot_evaluasi, nama_dosen, nama_mata_kuliah, insertid
                                        ) VALUES (
                                            '$id_kelas_kuliah', '$id_jenis_evaluasi', '$nama', '$nama_inggris', '$nomor_urut', '$bobot_evaluasi', '$nama_dosen', '$nama_mata_kuliah', '$insertid'
                                        )";
