...
$ModuleName = "RENCANA EVALUASI";
$table = "insertrencanaevaluasi";
                                                                                ...
                                                                                <div class="card-header">
                                                                                    <table class='table table-striped' id='table1' border='1'>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>Nama Evaluasi</td>
                                                                                            <td>Deskripsi dalam Bahasa Indonesia</td>
                                                                                            <td>Deskripsi dalam Bahasa Inggris</td>
                                                                                            <td>Nomor Urut</td>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td colspan='7'>
                                                                                                <code>
                                                                                                    <pre>b0141207-0476-4a58-9a30-6bbe493cefb5	2	Presentasi	Presentasi Kelompok	-	10	0</pre>
                                                                                                </code>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                        ...
                        <div class="modal fade text-left" id="cancel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel160" aria-hidden="true">
                            ...
                            if (isset($_POST['input'])) {
                                ...
                                echo "<table class='table table-striped' id='table1' border='1'><tr>
                                    <th>Baris</th><th>ID Kelas Kuliah</th><th>ID Jenis Evaluasi</th><th>Nama Evaluasi</th><th>Deskripsi Indonesia</th><th>Deskripsi Inggris</th><th>Nomor Urut</th><th>Bobot Evaluasi (%)</th></tr>";
                                foreach ($line as $baris) {
                                    ...
                                    if (isset($baris[2])) {
                                        ...
                                        $nama_evaluasi = $baris[2];
                                        $deskripsi_indonesia = $baris[3];
                                        $deskripsi_inggris = $baris[4];
                                        $nomor_urut= $baris[5];
                                        $bobot_evaluasi = $baris[6];
                                        // $datakelaskuliah = caridatakelaskuliah($id_matkul);

                                        echo "<tr><td>" . $no;
                                        echo "</td><td>" . $id_matkul;
                                        echo "</td><td>" . $id_jenis_evaluasi;
                                        echo "</td><td>" . $nama_evaluasi;
                                        echo "</td><td>" . $deskripsi_indonesia;
                                        echo "</td><td>" . $deskripsi_inggris;
                                        echo "</td><td>" . $nomor_urut;
                                        echo "</td><td>" . $bobot_evaluasi . "</td></tr>";
                                        ...
                                        $insert = "INSERT INTO insertrencanaevaluasi (
                                            id_matkul, id_jenis_evaluasi, nama_evaluasi, deskripsi_indonesia, deskripsi_inggris, nomor_urut, bobot_evaluasi, insertid
                                        ) VALUES (
                                            '$id_matkul', '$id_jenis_evaluasi', '$nama_evaluasi', '$deskripsi_indonesia', '$deskripsi_inggris', '$nomor_urut', '$bobot_evaluasi', '$insertid'
                                        )";
