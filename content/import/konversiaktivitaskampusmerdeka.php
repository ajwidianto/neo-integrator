...
$ModuleName = "KONVERSI AKTIVITAS KAMPUS MERDEKA";
$table = "insertkonversiaktivitaskampusmerdeka";
...
<div class="content-wrapper container">
    ...
    <th>Baris</th><th>ID Semester</th><th>ID Matkul</th><th>Kode Matkul</th><th>Nama Prodi</th><th>ID Anggota</th><th>ID Aktivitas</th><th>SKS Matkul</th><th>Nilai Angka</th><th>Nilai Indeks</th>
    <th>Nilai Huruf</th></tr>";
                                foreach ($line as $baris) {
                                    ...
                                    if (isset($baris[2])) {
                                        ...
                                        $nama_program_studi = $baris[2];
                                        $id_anggota = $baris[3];
                                        $id_aktivitas = $baris[4];
                                        $nilai_angka = $baris[5];
                                        $nilai_indeks = $baris[6];
                                        $nilai_huruf = $baris[7];
                                        $listmatakuliah = carilistmatakuliah($kode_mata_kuliah, $nama_program_studi);

                                        echo "<tr><td>" . $no;
                                        echo "</td><td>" . $id_semester;
                                        echo "</td><td>" . $listmatakuliah['id_matkul'];
                                        echo "</td><td>" . $kode_mata_kuliah;
                                        echo "</td><td>" . $nama_program_studi;
                                        echo "</td><td>" . $id_anggota;
                                        echo "</td><td>" . $id_aktivitas;
                                        echo "</td><td>" . $listmatakuliah['sks_mata_kuliah'];
                                        echo "</td><td>" . $nilai_angka;
                                        echo "</td><td>" . $nilai_indeks;
                                        echo "</td><td>" . $nilai_huruf . "</td></tr>";
                                        
                                        // Pastikan $listmatakuliah sudah terisi sebelum bagian ini
                                        $id_matkul = $listmatakuliah['id_matkul'] ?? 'Tidak Ditemukan';
                                        $sks_mata_kuliah = $listmatakuliah['sks_mata_kuliah'] ?? 'Tidak Ditemukan';

                                        $insert = "INSERT INTO insertkonversiaktivitaskampusmerdeka (
                                            id_matkul, kode_mata_kuliah, nama_program_studi, id_semester, id_anggota, id_aktivitas, sks_mata_kuliah, 
                                            nilai_angka, nilai_indeks, nilai_huruf, insertid
                                        ) VALUES (
                                            '$id_matkul', '$kode_mata_kuliah', '$nama_program_studi', '$id_semester', '$id_anggota', '$id_aktivitas', '$sks_mata_kuliah', 
                                            '$nilai_angka', '$nilai_indeks', '$nilai_huruf', '$insertid'
                                        )";
