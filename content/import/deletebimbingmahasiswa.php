...
$ModuleName = "DELETE BIMBING AKTIVITAS KULIAH";
$table = "deletebimbingmahasiswa";
                    ...
                    <a href="' . $link2 . '"><button class="btn btn-success ml-1" >LIHAT DATA / LANJUTKAN SYNC</button></a>
                        ...
                        <div class="modal fade text-left" id="cancel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel160" aria-hidden="true">
                            ...
                            if (isset($_POST['input'])) {
                                ...
                                <th>Baris</th><th>ID Bimbing Mahasiswa</th></tr>";
                                foreach ($line as $baris) {
                                    $baris = explode("\t", $baris);
                                    if (isset($baris[0])) {
                                        $no++;
                                        str_replace('"', '', $baris);
                                        $id_bimbing_mahasiswa = $baris[0];

                                        echo "<tr><td>" . $no;
                                        echo "</td><td>" . $id_bimbing_mahasiswa . "</td></tr>";
                                        
                                        // Pastikan $datamahasiswa sudah terisi sebelum bagian ini

                                        $insert = "INSERT INTO deletebimbingmahasiswa (
                                            id_bimbing_mahasiswa, insertid
                                        ) VALUES (
                                            '$id_bimbing_mahasiswa', '$insertid'
                                        )";
