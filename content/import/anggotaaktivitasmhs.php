...
$ModuleName = "ANGGOTA AKTIVITAS MAHASISWA";
$table = "insertanggotaaktivitasmahasiswa";
                        ...
                        <div class="modal fade text-left" id="cancel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel160" aria-hidden="true">
                            ...
                            if (isset($_POST['input'])) {
                                ...
                                echo "<table class='table table-striped' id='table1' border='1'><tr>
                                    <th>Baris</th><th>ID Aktivitas</th><th>NIM</th><th>NAMA</th><th>ID_Reg_mhs</th><th>Jenis Peran</th></tr>";
                                foreach ($line as $baris) {
                                    ...
                                    if (isset($baris[2])) {
                                        ...
                                        $insert = "INSERT INTO insertanggotaaktivitasmahasiswa (
                                            ...
                                            '$id_aktivitas', '$nim', '$nama_mahasiswa', '$id_reg_mhs', '$jenis_peran', '$insertid'
                                        )";
