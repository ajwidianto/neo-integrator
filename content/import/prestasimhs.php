...
$ModuleName = "PRESTASI MAHASISWA";
$table = "insertprestasimahasiswa";
                        ...
                        <div class="modal fade text-left" id="cancel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel160" aria-hidden="true">
                            ...
                            if (isset($_POST['input'])) {
                                ...
                                echo "<table class='table table-striped' id='table1' border='1'><tr>
                                    <th>Baris</th><th>NIM</th><th>NAMA</th><th>ID MHS</th><th>ID PT</th><th>ID Jenis Prestasi</th><th>ID Tingkat Prestasi</th><th>Nama Prestasi</th><th>Tahun Prestasi</th><th>Penyelenggara</th><th>Peringkat</th><th>ID Aktivitas</th></tr>";
                                foreach ($line as $baris) {
                                    ...
                                    if (isset($baris[2])) {
                                        ...
                                        $id_perguruan_tinggi = $baris[1];
                                        $id_jenis_prestasi = $baris[2];
                                        $id_tingkat_prestasi = $baris[3];
                                        $nama_prestasi = $baris[4];
                                        $tahun_prestasi = $baris[5];
                                        $penyelenggara = $baris[6];
                                        $peringkat = $baris[7];
                                        $id_aktivitas = $baris[8];
                                        ...
                                        echo "</td><td>" . $id_jenis_prestasi;
                                        echo "</td><td>" . $id_tingkat_prestasi;
                                        echo "</td><td>" . $nama_prestasi;
                                        echo "</td><td>" . $tahun_prestasi;
                                        echo "</td><td>" . $penyelenggara;
                                        echo "</td><td>" . $peringkat;
                                        ...
                                        $insert = "INSERT INTO insertprestasimahasiswa (
                                            id_mahasiswa, id_perguruan_tinggi, nim, nama_mahasiswa, id_jenis_prestasi, id_tingkat_prestasi, nama_prestasi, tahun_prestasi, penyelenggara, peringkat, id_aktivitas, insertid
                                        ) VALUES (
                                            '$id_mahasiswa', '$id_perguruan_tinggi', '$nim', '$nama_mahasiswa', '$id_jenis_prestasi', '$id_tingkat_prestasi', '$nama_prestasi', '$tahun_prestasi', '$penyelenggara', '$peringkat', '$id_aktivitas', '$insertid'
                                        )";
