...
$ModuleName = "UPDATE AKTIVITAS MAHASISWA";
$table = "updateaktivitasmahasiswa";
...
<div class="content-wrapper container">
    ...
    <th>Jenis Aktivitas</th><th>Jenis Anggota</th><th>Judul</th><th>Keterangan</th><th>Lokasi</th><th>Tanggal Mulai</th><th>Tanggal Akhir</th><th>ID Aktivitas</th></tr>";
                                foreach ($line as $baris) {
                                    ...
                                    if (isset($baris[2])) {
                                        ...
                                        $insert = "INSERT INTO updateaktivitasmahasiswa (
                                            id_prodi, nama_jenjang_pendidikan, nama_program_studi, id_semester, judul, keterangan, lokasi, 
                                            program_mbkm, id_jenis_aktivitas, jenis_anggota, sk_tugas, tanggal_sk_tugas, tanggal_mulai, tanggal_selesai, id_aktivitas, 
                                            insertid
                                        ) VALUES (
                                            '$id_prodi', '$nama_jenjang_pendidikan', '$nama_program_studi', '$id_semester', '$judul', '$keterangan', '$lokasi', 
                                            '$program_mbkm', '$id_jenis_aktivitas', '$jenis_anggota', '$sk_tugas', '$tanggal_sk_tugas', '$tanggal_mulai', 
                                            '$tanggal_selesai', '$id_aktivitas', '$insertid'
                                        )";
