...
$ModuleName = "SALIN KOMPONEN EVALUASI MATKUL";
$table = "insertsalinkomponenevaluasimatkul";
                        ...
                        <div class="modal fade text-left" id="cancel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel160" aria-hidden="true">
                            ...
                            if (isset($_POST['input'])) {
                                ...
                                echo "<table class='table table-striped' id='table1' border='1'><tr>
                                    <th>Baris</th><th>ID Matkul</th><th>ID Kelas Kuliah</th></tr>";
                                foreach ($line as $baris) {
                                    ...
                                    if (isset($baris[2])) {
                                        ...
                                        str_replace('"', '', $baris);
                                        $id_matkul = $baris[0];
                                        $id_kelas_kuliah = $baris[1];

                                        echo "<tr><td>" . $no;
                                        echo "</td><td>" . $id_matkul;
                                        echo "</td><td>" . $id_kelas_kuliah . "</td></tr>";

                                        $insert = "INSERT INTO insertsalinkomponenevaluasimatkul (
                                            id_kelas_kuliah, id_matkul, insertid
                                        ) VALUES (
                                            '$id_kelas_kuliah', '$id_matkul', '$insertid'
                                        )";
