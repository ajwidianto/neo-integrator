...
$ModuleName = "SKALA NILAI PRODI";
$table = "insertskalanilaiprodi";
                                                                                ...
                                                                                <div class="card-header">
                                                                                    <table class='table table-striped' id='table1' border='1'>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td colspan='7'>
                                                                                                <code>
                                                                                                    <pre>N. AZIZIA GIA MUTIARASRAI	DDK2CAB3	2	12	1</pre>
                                                                                                </code>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                        ...
                        <div class="modal fade text-left" id="cancel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel160" aria-hidden="true">
                            ...
                            if (isset($_POST['input'])) {
                                ...
                                echo "<table class='table table-striped' id='table1' border='1'><tr>
                                    <th>Baris</th><th>ID Prodi</th><th>Jenjang Pendidikan</th><th>Nama Prodi</th><th>Nilai Huruf</th><th>Nilai Indekx</th><th>Bobot Minimum</th><th>Bobot Maksimum</th><th>Tanggal Mulai Efektif</th><th>Tanggal Akhir Efektif</th></tr>";
                                foreach ($line as $baris) {
                                    $baris = explode("\t", $baris);
                                    if (isset($baris[2])) {
                                        $no++;
                                        str_replace('"', '', $baris);
                                        $kode_program_studi = $baris[0];
                                        $nilai_huruf = $baris[1];
                                        $nilai_indeks = $baris[2];
                                        $bobot_minimum = $baris[3];
                                        $bobot_maksimum = $baris[4];
                                        $tanggal_mulai_efektif = $baris[5];
                                        $tanggal_akhir_efektif = $baris[6];
                                        $dataprodi = cariidprodi($kode_program_studi);

                                        echo "<tr><td>" . $no;
                                        echo "</td><td>" . $dataprodi['id_prodi'];
                                        echo "</td><td>" . $dataprodi['nama_jenjang_pendidikan'];
                                        echo "</td><td>" . $dataprodi['nama_program_studi'];
                                        echo "</td><td>" . $nilai_huruf;
                                        echo "</td><td>" . $nilai_indeks;
                                        echo "</td><td>" . $bobot_minimum;
                                        echo "</td><td>" . $bobot_maksimum;
                                        echo "</td><td>" . $tanggal_mulai_efektif;
                                        echo "</td><td>" . $tanggal_akhir_efektif . "</td></tr>";

                                        // Pastikan $datakelaskuliah sudah terisi sebelum bagian ini
                                        $id_prodi = $dataprodi['id_prodi'];
                                        $nama_jenjang_pendidikan = $dataprodi['nama_jenjang_pendidikan'];
                                        $nama_program_studi = $dataprodi['nama_program_studi'];

                                        $insert = "INSERT INTO insertskalanilaiprodi (
                                            id_prodi, kode_program_studi, nama_jenjang_pendidikan, nama_program_studi, nilai_huruf, nilai_indeks, bobot_minimum, bobot_maksimum, tanggal_mulai_efektif, tanggal_akhir_efektif, insertid
                                        ) VALUES (
                                            '$id_prodi', '$kode_program_studi', '$nama_jenjang_pendidikan', '$nama_program_studi', '$nilai_huruf', '$nilai_indeks', '$bobot_minimum', '$bobot_maksimum', '$tanggal_mulai_efektif', '$tanggal_akhir_efektif', '$insertid'
                                        )";
