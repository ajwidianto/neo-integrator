...
$ModuleName = "UPDATE BIODATA MAHASISWA";
$table = "updatebiodatamahasiswa";
                    ...
                    <a href="' . $link2 . '"><button class="btn btn-success ml-1" >LIHAT DATA / LANJUTKAN SYNC</button></a>
                        ...
                        <div class="modal fade text-left" id="cancel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel160" aria-hidden="true">
                            ...
                            if (isset($_POST['input'])) {
                                ...
                                <th>Baris</th><th>Nama</th><th>ID_Mahasiswa</th><th>Data 1</th><th>Data 2</th><th>Data 3</th><th>Data 4</th><th>Data 5</th></tr>";
                                foreach ($line as $baris) {
                                    $baris = explode("\t", $baris);
                                    if (isset($baris[2])) {
                                        $no++;
                                        str_replace('"', '', $baris);
                                        $id_mahasiswa = $baris[0];
                                        $datamahasiswa = cariidmahasiswa_by_id_mahasiswa($id_mahasiswa);
                                        $data1 = $baris[1];
                                        $data2 = $baris[2];
                                        $data3 = $baris[3];
                                        $data4 = $baris[4];
                                        ...
                                        echo "</td><td>" . $id_mahasiswa;
                                        echo "</td><td>" . $data1;
                                        echo "</td><td>" . $data2;
                                        echo "</td><td>" . $data3;
                                        echo "</td><td>" . $data4;
                                        echo "</td><td>" . $data5 . "</td></tr>";
                                        
                                        // Pastikan $datamahasiswa sudah terisi sebelum bagian ini
                                        $nama_mahasiswa = $datamahasiswa['nama_mahasiswa'] ?? 'Tidak Ditemukan';

                                        $insert = "INSERT INTO updatebiodatamahasiswa (
                                            nama_mahasiswa, id_mahasiswa, data1, data2, data3, data4, data5, insertid
                                        ) VALUES (
                                            '$nama_mahasiswa', '$id_mahasiswa', '$data1', '$data2', '$data3', '$data4', '$data5', '$insertid'
                                        )";
