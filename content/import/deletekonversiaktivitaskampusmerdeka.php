...
$ModuleName = "DELETE KONVERSI AKTIVITAS KAMPUS MERDEKA";
$table = "deletekonversiaktivitaskampusmerdeka";
                    ...
                    <a href="' . $link2 . '"><button class="btn btn-success ml-1" >LIHAT DATA / LANJUTKAN SYNC</button></a>
                        ...
                        <div class="modal fade text-left" id="cancel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel160" aria-hidden="true">
                            ...
                            if (isset($_POST['input'])) {
                                ...
                                <th>Baris</th><th>ID Delete Konversi Aktivitas Kampus Merdeka</th></tr>";
                                foreach ($line as $baris) {
                                    $baris = explode("\t", $baris);
                                    if (isset($baris[0])) {
                                        $no++;
                                        str_replace('"', '', $baris);
                                        $id_konversi_aktivitas = $baris[0];

                                        echo "<tr><td>" . $no;
                                        echo "</td><td>" . $id_konversi_aktivitas . "</td></tr>";
                                        
                                        // Pastikan $datamahasiswa sudah terisi sebelum bagian ini

                                        $insert = "INSERT INTO deletekonversiaktivitaskampusmerdeka (
                                            id_konversi_aktivitas, insertid
                                        ) VALUES (
                                            '$id_konversi_aktivitas', '$insertid'
                                        )";
